...
class _Soccerstate extends State<Soccer> {
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async{
                          ...
                          sharepref1.setInt(homepage.count, 1);
                          sharepref1.setInt(Soccer.amaze2, e.gameId);
  ...
  void matchdata() {
    socket2 = IO.io("https://we.trionixtech.live:5600/1", <String, dynamic>{
    ...
    socket2!.onConnect((_) {
      print("connect");
      Timer a = Timer.periodic(Duration(seconds: 1), (value) {
        socket2!.on("1", (data) {
          print(data);
          socket2!.disconnect();
